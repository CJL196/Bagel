...
DATASET_INFO = {
    't2i_pretrain': {
        't2i': {
            'data_dir': 'dataset/bagel_example/t2i', # path of the parquet files
    ...
    'vlm_sft': {
        'llava_ov': {
			'data_dir': 'dataset/bagel_example/vlm/images',
			'jsonl_path': 'dataset/bagel_example/vlm/llava_ov_si.jsonl',
			'num_total_samples': 1000
		},
    },
}